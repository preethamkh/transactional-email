...
| 7 | **Accreditation repo access** (`dev.azure.example.com/Accreditation/_git/Accreditation`) | Manager | Needed to design the integration story for the separated portal — both portals must be served by whichever option wins. | Before final decision |
...
5. **"Option 4 makes the vendor decision reversible."** If organisation later wants Customer Insights journeys or Mailchimp designs, they become adapters or design tools — not rewrites. The decision stops being a bet.
